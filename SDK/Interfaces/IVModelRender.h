...
public:
	virtual int* GetTextureValue(void) = 0;
	...
	virtual void SetTextureValue(int*) = 0;
...
public:
	...
	virtual PreviewImageRetVal_t GetPreviewImageProperties(int* width, int* height, int* param, bool* isTranslucent) const = 0;
	virtual PreviewImageRetVal_t GetPreviewImage(unsigned char* data, int width, int height, int param) const = 0;
	...
	virtual void SetShaderAndParams(int* pint) = 0;
...
public:
	...
	virtual ModelInstanceHandle_t CreateInstance(IClientRenderable* pRenderable, int* pCache = NULL) = 0;
	virtual void DestroyInstance(ModelInstanceHandle_t handle) = 0;
	virtual void SetStaticLighting(ModelInstanceHandle_t handle, int* pHandle) = 0;
	virtual int GetStaticLighting(ModelInstanceHandle_t handle) = 0;
	virtual bool ChangeInstance(ModelInstanceHandle_t handle, IClientRenderable* pRenderable) = 0;
	virtual void AddDecal(ModelInstanceHandle_t handle, int const& ray, Vector const& decalUp, int decalIndex, int body, bool noPokeThru = false, int maxLODToDecal = NULL) = 0;
	virtual void RemoveAllDecals(ModelInstanceHandle_t handle) = 0;
	virtual void RemoveAllDecalsFromAllModels() = 0;
	virtual matrix3x4_t* DrawModelShadowSetup(IClientRenderable* pRenderable, int body, int skin, int* pInfo, matrix3x4_t* pCustomBoneToWorld = NULL) = 0;
	virtual void DrawModelShadow(IClientRenderable* pRenderable, const int& info, matrix3x4_t* pCustomBoneToWorld = NULL) = 0;
	...
	virtual void AddColoredDecal(ModelInstanceHandle_t handle, int const& ray, Vector const& decalUp, int decalIndex, int body, int cColor, bool noPokeThru = false, int maxLODToDecal = NULL) = 0;
