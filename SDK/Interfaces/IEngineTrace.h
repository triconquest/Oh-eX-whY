...
struct Ray_t
{
	...
	{
		m_Delta = end - start;
		m_IsSwept = (m_Delta.LengthSqrt() != 0);
		m_Extents.Set();
		m_IsRay = true;
		m_StartOffset.Set();
		m_Start = start;
	...
	void Init(Vector const& start, Vector const& end, Vector const& mins, Vector const& maxs)
	{
		...
		m_IsRay = (m_Extents.LengthSqrt() < 1e-6);
...
public:
	...
	CTraceFilter(IHandleEntity* skip) : pSkip(skip) {}
...
public:
	...
	virtual bool GetBrushInfo(int iBrush, int* pPlanesOut, int* pContentsOut) = 0;
