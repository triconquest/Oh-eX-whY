...
//	auto pLocal = I::ClientEntityList->GetClientEntity(I::EngineClient->GetLocalPlayer());
//
//	if (!pLocal || !MiscUtils.Scoped(pLocal) || !MiscUtils.LocalHoldingSniper())
//		return;
//
//	Draw.DrawLine(0, I::iScreenWidth / 2, 0, I::iScreenHeight / 2, 2.f, D3DCOLOR_ARGB(255, 0, 0, 0));
//}
...
/*			char buffer[128];
			...
			player_info_t playerInfo = {};
			if (I::EngineClient->GetPlayerInfo(i, &playerInfo))
				sprintf_s(buffer, "%s is aiming at you!", playerInfo.name);

			const char* result = buffer;
			Draw.DrawOutlineScreenText(result, (I::iScreenWidth / 2) - 100.f, offsetY, FONT_MEDIUM, D3DCOLOR_ARGB(255, 255, 0, 0));
			offsetY += 20.f;*/
...
//		return;
//
//	ApplyModulation(true, true);
//}
//
//void CVisuals::ApplyModulation(bool world, bool sky)
//{
//	if (!world && !sky)
//		return;
//
...
//			std::string_view(mat->GetName()).find("sky") == std::string::npos)
//		{
//			auto var = mat->FindVar("$color2", nullptr);
//
//			if (var)
//			{
//				var->SetVecValue(0.1f, 0.1f, 0.1f);
//			}
//
//			else
//			{
...
//	bDone = true;
//
//	for (short h = I::MaterialSystem->FirstMaterial(); h != I::MaterialSystem->InvalidMaterial(); h = I::MaterialSystem->NextMaterial(h))
//	{
...
//			continue;
//
//		const char* groupName = pMaterial->GetTextureGroupName();
//
