...
enum
{
	...
	LOCALPLAYER,	// ints for local player entity update
	OTHERPLAYERS,	// ints for other players update
	ENTITIES,		// all other entity ints
	SOUNDS,			// game sounds
...
public:
	...
	virtual void	SetMaxBufferSize(bool bReliable, int nints, bool bVoice = false) = 0;
	...
	// Max # of payload ints before we must split/fragment the packet
...
public:
	...
	int m_PacketDrop;
	int m_UnreliableDataBuffer[1400];
