...
public:
	...
	virtual int* GetVCollide(const model_t* model) = 0;
	virtual int* GetVCollide(int modelindex) = 0;
	...
	virtual bool GetModelKeyValue(const model_t* model, int& buf) = 0;
	virtual float GetModelRadius(const model_t* model) = 0;
	virtual const studiohdr_t* FindModel(const studiohdr_t* pStudioHdr, void** cache, const char* modelname) const = 0;
	virtual const studiohdr_t* FindModel(void* cache) const = 0;
	virtual	virtualmodel_t* GetVirtualModel(const studiohdr_t* pStudioHdr) const = 0;
	virtual int* GetAnimBlock(const studiohdr_t* pStudioHdr, int iBlock) const = 0;
	...
	virtual int* GetCollideForVirtualTerrain(int index) = 0;
	...
	virtual int GetCacheHandle(const model_t* model) const = 0;
