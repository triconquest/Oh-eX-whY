...
public:
	...
	virtual int* GetUserCmd(int sequence_number) = 0;
	...
	virtual void SetPreferredGameActionSet(int action_set) = 0;
	virtual int GetPreferredGameActionSet() = 0;
	virtual void SetGameActionSetFlags(GameActionSetFlags_t action_set_flags) = 0;
	virtual void LevelInit(void) = 0;
	virtual void ClearInputButton(int bits) = 0;
	virtual	void CAM_SetCameraThirdData(CameraThirdData_t* pCameraData, const int& vecCameraOffset) = 0;
