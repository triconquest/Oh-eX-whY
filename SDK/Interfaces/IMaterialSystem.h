...
public:
    ...
    virtual int Init(char const* pShaderAPIDLL, IMaterialProxyFactory* pMaterialProxyFactory, int fileSystemFactory, int cvarFactory = NULL) = 0;
    ...
    virtual int* CreateRenderContext(MaterialContextType_t type) = 0;
    virtual int* SetRenderContext(int*) = 0;
