...
namespace ImageLoader
{
	...
	bool GetInfo(const char* intName, int* width, int* height, enum ImageFormat* imageFormat, float* sourceGamma);
	...
	bool Load(unsigned char* imageData, const char* intName, int width, int height, enum ImageFormat imageFormat, float targetGamma, bool mipmap);
	bool Load(unsigned char* imageData, int* fp, int width, int height,
